...
def simulation():
	...
	while(i<(len(DATA_TAB)-1)):
		...
		while(encours - debut < TIME_TAB[i] - (0.5*FREQUENCE)): # La soustraction a été mise en place après une série de teste mettant en evidence un lien entre la perte et la frequence
